...
/**
 * This is the extension manager of the Utclarchiveorders extension.
 */
public class UtclarchiveordersManager extends GeneratedUtclarchiveordersManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(UtclarchiveordersManager.class.getName());
	 ...
	 */
	public static UtclarchiveordersManager getInstance()
	{
		return (UtclarchiveordersManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				UtclarchiveordersConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public UtclarchiveordersManager() 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of UtclarchiveordersManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of UtclarchiveordersManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of UtclarchiveordersManager called, current tenant: " + getTenant().getTenantID());
		}
	}
